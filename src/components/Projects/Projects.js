...
import chainride from "../../Assets/Projects/chainride.png";
          ...
          <Col md={4} className="project-card">
           ...
           <Col md={4} className="project-card">
            <ProjectCard
              imgPath={chainride}
              isBlog={false}
              title="ChainRide — Blockchain Transport Ticketing"
              description="A decentralized public transport ticketing system built on Ethereum. Each ticket is minted as an ERC-721 NFT using Solidity smart contracts. Features include blockchain-backed ticket issuance, gate validation, instant 50% refund on cancellation, real-time train tracking, and a live blockchain explorer. Zero fraud possible — every ticket is cryptographically unique."
              ghLink="https://github.com/Vinay7911/transport-dapp"
              techStack={["Ethereum", "Solidity", "React.js", "Node.js", "ethers.js", "Hardhat", "MetaMask"]}
            />
          </Col>
